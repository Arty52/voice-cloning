...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("sample_mode", sa.String(length=32), server_default="excerpt", nullable=False),
        ...
        sa.Column("voice_preset_id", sa.String(length=64), server_default="standardNarration", nullable=False),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column("provider_id", sa.String(length=64), server_default="elevenlabs", nullable=False),
